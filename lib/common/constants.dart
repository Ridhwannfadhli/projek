...
class Constants {
  ...
  static List<Fortune> generateNumberRange(int start, int end) {
    return List.generate(
      end - start + 1,
          (index) => Fortune(
        id: index + start,
        backgroundColor: Colors.primaries[Random().nextInt(Colors.primaries.length)],
        titleName: '${index + start}',
      ),
    );
  }

  static List<Fortune> customNumberRange(int rangeStart, int rangeEnd) {
    return generateNumberRange(rangeStart, rangeEnd);
  }
}
